...
const TableComponent = () => {
    ...
    const emprendimientoRows = ["$10", "$25 /mes", "$34 /mes", "2 usuarios", "1", "1.000", "check", "check", "check", "check", "check", "check", "check", "check"];
    ...
    const tableCard = [
        { id: 1, table: emprendimientoRows, title: "Emprendimiento" },
        { id: 2, table: expansionRows, title: "Expansión", type: "selected" },
